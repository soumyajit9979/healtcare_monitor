...
#define WIFI_SSID "Gokulraj"     //your wifi name
#define WIFI_PASSWORD "gokul000"      //wifi password
unsigned long myChannelNumber = 2199837;    //channel id from thingspeak
const char * myWriteAPIKey = "W6YVSV39KENBIQFV";    //read API from thingspeak
